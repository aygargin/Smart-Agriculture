...
session_start();
extract($_REQUEST);
$user=$_SESSION['adm_name'];

if($user=="")
header("location:signout.php");

$f=mysql_fetch_array(mysql_query("select * from farmer_db where s_no='$edit'"));
$photo = $f['photo'];
?>
...
$z=MD5($pass);
 ...
 {	 
	if($pass==$pass1)
	{
		...
		$qry=mysql_query("update farmer_db set name='$name', aadhaar ='$aadhaar', password='$z', photo='$tempname', address='$address', village='$village' ,district ='$district',state = '$state' ,pin='$pin',phone='$phone' where s_no='$edit'");
