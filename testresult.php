...
header("location:signout.php");
	...
	$aa=$f['aadhaar'];
	$q=mysql_query("select n_id,writekey from device where aadhaar='$aa' order by n_id desc");
...
<aside class="col-md sidebar sidebar-right" style="float:right">
	<div class="row widget">
		<div class="col-xs-12">
			...
			<select>
            <option>Choose device-id</option>                
                <option value="red"><?php echo $nid_values[0];?></option>
                <option value="blue"><?php echo $nid_values[1];?></option>
        </select>	
...
<table style="border-collapse:collapse" width="100%" border="2" cellpadding="6">
  <tr>
    ...
    <th bgcolor="#c2d69b" colspan="4" scope="col">
	<div class="red box"><?php echo $nid_values[0];?></div>
    <div class="blue box"><?php echo $nid_values[1];?></div>
    </th>
  </tr>
  <tr>
    ...
    <th bgcolor="#c2d69b" colspan="4" scope="col">
	<div class="red box"><?php echo $wk_values[0];?></div>
    <div class="blue box"><?php echo $wk_values[1];?></div>
	</th>
  </tr>
  <tr>
