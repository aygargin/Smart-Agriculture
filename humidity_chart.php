...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,hi', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="f_profile.php">Home</a></li>
			<li class="active">Humidity Chart</li>
		</ol>
		...
		<div class="row" align="justify">
			...
			<article class="col-md maincontent">
				<header class="page-header">
                	<h1 class="page-title" align="center">Humidity Chart</h1>
				</header>
				<p>Soil water content is the physical parameter used to characterise the availability of water for plants in the soil. The aim of this method is to provide a fast measurement value and to provide values for continuous measurements over longer periods at a certain time interval.</p>
				
                <p>Soil water content is either calculated as an absolute value (g water /g soil), or relative to the water holding capacity (% of water holding capacity). In all cases, it must be considered that soil water content provides well-characterised values, but the actual biologically available water content for the plants may be significantly different. To measure soil moisture content, we used an old method of measuring the soil resistance, the moisture content of soil inversely depends on the soil resistance. More the resistance of soil lesser will be the moisture content and vice-versa.</p>
				
                <p>The plot for the whole month for humidity is given as:</p>
