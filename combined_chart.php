...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,hi', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="f_profile.php">Home</a></li>
			<li class="active">Combined Chart</li>
		</ol>
		...
		<div class="row" align="justify">
			...
			<article class="col-md maincontent">
				<header class="page-header">
                	<h1 class="page-title" align="center">Combined Chart</h1>
				</header>
	...
	{		
		...
		$qq=mysql_query("select * from reading where writekey='$wk' AND n_id='$n_id' order by created_at asc");
			...
			while($fff=mysql_fetch_array($qq))
			{
				...
				$result_array2[] = $fff['temp'];
				$result_array3[] = $fff['ph'];				
...
?>
    ...
    <script>
        ...
        var config = {
            ...
            data: {
				...
				datasets: [{
                    ...
                    label: "Temperature",
                    data: <?php echo $json_array2; ?>,
					borderDash: [10, 10],
					
                },{
                    label: "ph",
                    data: <?php echo $json_array3; ?>,
        ...
        $.each(config.data.datasets, function(i, dataset) {
            dataset.borderColor = randomColor(25);
